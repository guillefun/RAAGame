...
public class PararbolaController : MonoBehaviour
{
    /// <summary>
    /// Animation Speed
    /// </summary>
    ...
    void Update()
    {
        ...
        else if (Animation && parabolaFly != null && animationTime > parabolaFly.GetDuration())
        {
            ...
            //Animation = false;
            //transform.position = new Vector3(0.0f, -0.081f, 3.074f);

            //GameObject g = GameObject.FindGameObjectWithTag("salvaje");
            // g.SetActive(false);
            //g.transform.position = new Vector3(g.transform.position.x, g.transform.position.y-5, g.transform.position.z);


            //transform.eulerAngles = Vector3.Lerp(transform.rotation.eulerAngles, to, Time.deltaTime);
            //CapturePokemon.enable(true);
        }
